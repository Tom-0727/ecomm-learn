...
<p><strong>关键认知</strong>：商城GMV = 品牌的「被动收入」——不需要每天直播也有销售。商城做好了，才是真正的品牌资产积累。</p>`,
  ...
  // ===== CASE 21 — 实战入门：闲鱼上架30件，浏览量3000，零成交 =====
  {
    id: 21,
    title: "新手卖家：闲鱼上架30件，浏览量3000，一单没成",
    difficulty: 1,
    category: "转化问题",
    background: `李同学在职状态下开始副业电商，从1688拿了30件「桌面收纳盒」上架闲鱼，定价39元（1688拿货价12元）。上架两周后，总浏览量约3000次，但从未收到过询价，零成交。他检查了一下：商品状态「在售」，价格比竞品低5元，每天有100+浏览量。他认为是「用户不需要」，准备换品。`,
    metrics: [
      { label: "上架商品数", value: "30件（同一款）", status: "ok" },
      { label: "2周总浏览量", value: "约3,000次", status: "ok" },
      { label: "询价/私信数", value: "0条", status: "bad" },
      { label: "成交单数", value: "0单", status: "bad" },
      { label: "主图质量", value: "直接用1688厂家图（白底，有水印）", status: "bad" },
      { label: "商品标题", value: "「桌面收纳盒 好看 实用 推荐」", status: "bad" },
      { label: "定价", value: "39元（低于闲鱼同款均价5元）", status: "ok" },
      { label: "商品描述", value: "「超好用的收纳盒，质量很好，需要的来」共15字", status: "bad" }
    ],
    options: [
      { id: "a", text: "卡在【需求洞察】—— 市场上没有人需要收纳盒这个品类，需要换品" },
      { id: "b", text: "卡在【内容运营/转化】—— 主图用厂家图+标题无关键词+描述过短，导致用户不点击、不信任，与定价无关" },
      { id: "c", text: "卡在【流量获取】—— 闲鱼没有付费推广渠道，必须转到有广告的平台" },
      { id: "d", text: "卡在【定价策略】—— 39元价格过高，需要亏本卖18元以下才能成交" }
    ],
    answer: "b",
    explanation: `
<h3>核心卡点：内容运营（主图+标题+描述三重失效）</h3>
<p><strong>数据证据链：</strong></p>
<ul>
  <li>浏览量3000次但询价0条 → 不是没流量，是有人看了但没有行动意愿 → 问题在内容质量</li>
  <li>主图用1688厂家图（带水印）→ 买家一眼认出这是「搬运货」，信任度为零</li>
  <li>标题「桌面收纳盒 好看 实用」→ 不含任何搜索关键词（尺寸/材质/容量/适用场景）→ 被搜索精准词的人找不到</li>
  <li>描述仅15字 → 买家核心问题（尺寸多大？多少格？材质？有无味道？）全部未回答 → 不问就不买</li>
</ul>

<h3>三重内容失效对照</h3>
<table border="1" style="border-collapse:collapse;width:100%;font-size:.9em">
  <tr><th style="padding:6px">维度</th><th>李同学的做法</th><th>正确做法</th></tr>
  <tr><td style="padding:6px">主图</td><td>1688厂家图（带水印）</td><td>白纸背景+自拍，真实感强，有人情味</td></tr>
  <tr><td style="padding:6px">标题</td><td>「桌面收纳盒 好看 实用」</td><td>「桌面收纳盒 抽屉式 A4纸大小 6格 办公室宿舍」</td></tr>
  <tr><td style="padding:6px">描述</td><td>15字，无实质信息</td><td>「尺寸：30×20×10cm，6格抽屉，可叠加，无异味，实拍如图，新品未使用。」</td></tr>
</table>

<h3>处方：10分钟改造，不换品</h3>
<ol>
  <li><strong>重拍主图</strong>：手机+白纸背景，商品摆好，多拍4张（正面/侧面/内部格子/与A4纸对比尺寸）</li>
  <li><strong>改标题</strong>：搜索闲鱼「桌面收纳」，看自动补全词，把排名靠前的词写进标题。如：「桌面收纳盒 办公室 抽屉式 多格 文具整理架」</li>
  <li><strong>补描述</strong>：回答买家最常问的5个问题：尺寸、材质、格子数量、能否叠加、是否全新</li>
  <li><strong>预期</strong>：改完后3天内会收到第一条询价</li>
</ol>
<p><strong>关键认知</strong>：闲鱼收纳盒类目月交易量超过10万件，需求没有问题。换品之前先检查内容——90%的新手零成交原因是内容问题，不是选品问题。</p>`,
    chainLink: 5  // 内容运营
  },

  // ===== CASE 22 — 实战入门：拼多多新店开了1个月，GMV=0 =====
  {
    id: 22,
    title: "拼多多新店：开店1个月，商品上架，销量为零",
    difficulty: 2,
    category: "流量获取",
    background: `王女士办好了个体营业执照，在拼多多开了一家日用品店铺，上架了5款商品（收纳整理类），价格参考竞品做到了「比均价低10%」。开店1个月后，5款商品总销量=0，总浏览量仅230次，没有任何评价。她认为是「拼多多流量太难了」，考虑关店。`,
    metrics: [
      { label: "开店时长", value: "1个月", status: "ok" },
      { label: "在售商品数", value: "5款", status: "ok" },
      { label: "总浏览量（1个月）", value: "230次", status: "bad" },
      { label: "成交单数", value: "0单，评价数=0", status: "bad" },
      { label: "是否开过推广", value: "未开任何付费推广", status: "bad" },
      { label: "定价", value: "比竞品均价低10%", status: "ok" },
      { label: "商品好评数", value: "0（全新店铺）", status: "bad" },
      { label: "有无私域引流", value: "未做，等待自然流量", status: "bad" }
    ],
    options: [
      { id: "a", text: "卡在【选品策略】—— 收纳类目竞争太激烈，新手不应该做此类目" },
      { id: "b", text: "卡在【流量获取+冷启动】—— 新店0评价、未投广告、未引私域流量，三重冷启动障碍导致平台不给自然流量" },
      { id: "c", text: "卡在【定价策略】—— 低于竞品的价格反而让用户怀疑质量，需要提价" },
      { id: "d", text: "卡在【履约物流】—— 未设置发货时效，导致系统不展示商品" }
    ],
    answer: "b",
    explanation: `
<h3>核心卡点：冷启动三重障碍</h3>
<p>拼多多新店的自然流量逻辑是：<strong>平台根据「商品历史表现」决定展示量</strong>。0评价、0销量的新品，平台判定为「不知道能不能卖」，默认给极少展示（这就是为什么1个月只有230次浏览）。</p>

<h3>新店冷启动三重障碍</h3>
<table border="1" style="border-collapse:collapse;width:100%;font-size:.9em">
  <tr><th style="padding:6px">障碍</th><th>王女士的情况</th><th>破解方法</th></tr>
  <tr><td style="padding:6px">①无评价</td><td>全新店铺，0评价</td><td>私域引第一批老客来评价（朋友+同事+家人）</td></tr>
  <tr><td style="padding:6px">②无历史销量</td><td>等待自然流量</td><td>先靠私域积累10-20单，平台才开始给自然流量</td></tr>
  <tr><td style="padding:6px">③未投推广</td><td>没有开广告</td><td>积累10个评价后，开搜索推广，每日预算30元测试</td></tr>
</table>

<h3>处方：冷启动30天行动计划</h3>
<ol>
  <li><strong>第1-2周：私域引流破零</strong><br>在微信发朋友圈（参照实战挑战3的私域首单方法），邀请朋友从拼多多下单，收到后请评价。目标：10单+10条五星好评</li>
  <li><strong>第3周：开启付费推广</strong><br>选销量最好的1款商品，开搜索推广（精准长尾词），日预算30元，跑7天</li>
  <li><strong>第4周：优化数据复盘</strong><br>查推广报告：CTR达均值→主图OK；转化率达1%→详情页OK；否则逐项优化</li>
  <li><strong>预期</strong>：按此计划，第2个月月GMV可达1000-3000元，第3个月可破5000元</li>
</ol>
<p><strong>关键认知</strong>：拼多多新店的正确姿势不是「等」而是「推」——先用私域流量激活商品，再用付费流量放大。纯等待自然流量是最低效的开店方式。</p>`,
    chainLink: 6  // 流量获取
  },

  // ===== CASE 23 — 实战入门：小红书发15篇笔记，总浏览量不到1000 =====
  {
    id: 23,
    title: "小红书新号：发了15篇笔记，总浏览量不到1000",
    difficulty: 2,
    category: "内容问题",
    background: `陈先生在小红书注册了新账号，计划通过内容引流卖「露营装备」。坚持更新1个月，发了15篇图文笔记，每篇配4-6张图。数据让他很沮丧：15篇总浏览量仅890次，点赞总计12个，没有一条购买询问。他的笔记大多是：「XX露营椅开箱 性价比超高！附链接」「露营装备推荐清单，包邮！」。他认为是「小红书对新号有流量限制，等权重起来就好了」。`,
    metrics: [
      { label: "发帖数量", value: "15篇（1个月）", status: "ok" },
      { label: "总浏览量", value: "890次（均约59次/篇）", status: "bad" },
      { label: "总点赞数", value: "12个（均0.8个/篇）", status: "bad" },
      { label: "收藏数", value: "3个", status: "bad" },
      { label: "购买询问", value: "0条", status: "bad" },
      { label: "笔记内容类型", value: "全部为商品推荐/开箱/清单（广告型）", status: "bad" },
      { label: "封面图风格", value: "商品白底图+大字「推荐」「链接」", status: "bad" },
      { label: "是否有真实户外内容", value: "无，未出现真实露营场景", status: "bad" }
    ],
    options: [
      { id: "a", text: "卡在【平台规则】—— 小红书对新号有流量限制期，继续等待权重自然提升" },
      { id: "b", text: "卡在【内容策略】—— 所有笔记都是广告型内容，缺乏生活真实感和有用价值，被平台和用户双重降权" },
      { id: "c", text: "卡在【选品策略】—— 露营装备在小红书受众有限，应换成美妆或家居品类" },
      { id: "d", text: "卡在【流量获取】—— 需要购买小红书商业推广（薯条），付费才能有流量" }
    ],
    answer: "b",
    explanation: `
<h3>核心卡点：内容策略（广告型 vs 种草型）</h3>
<p>小红书的推荐算法本质：<strong>系统识别「对用户有价值的内容」才会放大推流</strong>。「商品推荐+附链接」是系统识别度最高的广告信号，会直接降权或限流。</p>

<h3>广告型 vs 种草型 内容对比</h3>
<table border="1" style="border-collapse:collapse;width:100%;font-size:.9em">
  <tr><th style="padding:6px">维度</th><th>陈先生的做法（广告型）</th><th>有效的种草型</th></tr>
  <tr><td style="padding:6px">标题</td><td>「露营椅开箱 附链接」</td><td>「第一次独自露营，我带了这5件救命装备」</td></tr>
  <tr><td style="padding:6px">封面图</td><td>白底商品图+「推荐」大字</td><td>真实营地场景，人+装备，有氛围感</td></tr>
  <tr><td style="padding:6px">内容主角</td><td>商品本身</td><td>「我的露营经历」，商品是配角</td></tr>
  <tr><td style="padding:6px">结尾</td><td>「点主页买」「评论区有链接」</td><td>「第一次露营有什么问题欢迎问我」</td></tr>
  <tr><td style="padding:6px">用户收获</td><td>无（只是广告）</td><td>可以学到「独自露营怎么准备」</td></tr>
</table>

<h3>关于「新号流量限制」的真相</h3>
<p>小红书确实对新号有「考察期」，但这不是核心问题。真正的考察维度是：<strong>用户互动率（收藏率/点赞率）</strong>。如果新号发的内容被真实用户收藏，系统会给新号也很高的推流。陈先生15篇只有3个收藏（收藏率0.3%），说明内容对用户没有保存价值。</p>

<h3>处方：内容重构方案</h3>
<ol>
  <li><strong>停止更新2-3天</strong>，不要继续发广告型内容（继续发只会加重系统对账号的「广告标签」）</li>
  <li><strong>策划3篇「价值型」内容</strong>：<br>
    · 「我踩过的3个露营新手坑（附解决方案）」<br>
    · 「周末两天一夜露营装备清单，按预算1000元规划」<br>
    · 「[地点]露营攻略，含营地信息+装备搭配+拍照角度」</li>
  <li><strong>封面图改造</strong>：用真实户外场景照片，人物+风景+装备，不要写「推荐」「链接」等商业词</li>
  <li><strong>引流方式调整</strong>：不在正文放链接，改为「想了解哪款装备评论区告诉我」，在私信里承接购买意向</li>
  <li><strong>预期</strong>：按此方向调整后，第1篇价值型内容有60%概率突破500浏览，优质笔记可达3000-10000浏览</li>
</ol>
<p><strong>关键认知</strong>：在小红书「卖货」的正确心智是「先成为领域达人，再自然带货」。15篇广告型内容的效果，不如1篇真实露营攻略。</p>`,
    chainLink: 5  // 内容运营
  }
];
